...
Copyright (c) 2014-2015 PesoDigital developers
...
About PesoDigital
-------------
PesoDigital is a PesoDigital network-compatible, community-developed wallet client.

The project has been designed to provide people with a
stable, secure, and feature-rich alternative to the PesoDigital reference
wallet (https://github.com/PesoDigitalFoundation/PesoDigital).

To help faciliate broad community cooperation, a number of trusted
PesoDigital/Peershares community leaders have write permissions to the project's
...
Resources
---------
PesoDigital source code: https://github.com/PesoDigitalFoundation/PesoDigital

For the most current instructions covering how to compile PesoDigital from
source on a variety of operating systems, please visit:
https://github.com/PesoDigitalFoundation/PesoDigital/tree/master/doc

Open software issues can be viewed, and new issues can be reported at:
https://github.com/PesoDigitalFoundation/PesoDigital/issues?state=open

PesoDigital discussion forums (hosted by PesoDigital.com):
http://talk.PesoDigital.com/categories/coincode



Acknowledgements
----------------
PesoDigital owes it's existance to the time and effort put forth by
