PesoDigital version 0.2.0.0 is now available from:
...
PesoDigital data directory (listed below) and delete everything except the
wallet.dat and PesoDigital.conf

Linux : ~/.PesoDigital/

Windows : %appdata%\Roaming\PesoDigital
...
- `62a3da1` Update GitHub URLs to point to PesoDigitalFoundation/PesoDigital
...
- `19ca0ef` Point GitHub URL to PesoDigitalFoundation
