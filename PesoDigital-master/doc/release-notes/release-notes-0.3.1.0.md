PesoDigital version 0.3.1.0 is now available from:
...
- `6a3e798` PesoDigital-Qt (Windows only): enable DEP for PesoDigital-qt.exe
...
Miscellaneous:
- `fb66d3f` remove pre-PesoDigital protocol versions
