PesoDigital version 0.3.3.1 is now available from:
...
Added support for PesoDigital URIs in QT wallet.
...
- `722c5dc` Change strings to PesoDigital (uppercase) and other miscellaneous fixes
- `18993f7` Correct translatable string from Bitcoin to PesoDigital
- `a0cb315` Remove duplicate spaces from a string
- `648fc59` Add an option to open the PesoDigital.conf in the default editor
- `80dbe2e` Add a notice when selecting edit config in QT
- `02d42ae` Fix Opening on OSX
- `4898c94` PesoDigital-Qt (Windows only): extend Resource File
...
- `0142107` Change Window title to "PesoDigital - Wallet" / misc related renames
...
- `f687b68` Add support for opening PesoDigital: URIs directly.
...
- `c5c281a` Rename project to PesoDigital-qt
...
- `ca2ae7a` Rename rpcuser from bitcoinrpc --> PesoDigitalrpc in message dialog
