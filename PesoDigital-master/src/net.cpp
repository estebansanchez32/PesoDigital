...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PesoDigital " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are PesoDigital dns seeds.
static const char *strDNSSeed[][2] = {
    {"dnsseed.PesoDigital.com", "dnsseed.PesoDigital.com"},
    {"dnsseed.PesoDigitalfoundation.org", "dnsseed.PesoDigitalfoundation.org"},
    {"dnsseed.xpydev.org", "dnsseed.xpydev.org"},
    {"tseed.PesoDigital.com", "tseed.PesoDigital.com"},
    {"testnet-seed.PesoDigital.mitchellcash.com", "testnet-seed.PesoDigital.mitchellcash.com"} // Mitchell Cash
};
...
unsigned int pnSeed[] =
{
    // Hard Code DNS Seed IPS for PesoDigital, PesoDigitalfoundation, xpydev
...
// PesoDigital: stake minter thread
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PesoDigital is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // PesoDigital: mint proof-of-stake blocks in the background
