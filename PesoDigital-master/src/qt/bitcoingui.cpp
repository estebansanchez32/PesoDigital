 ...
 * The PesoDigital Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("PesoDigital") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    setWindowIcon(QIcon(":icons/PesoDigital"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a PesoDigital address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/PesoDigital"), tr("&About PesoDigital"), this);
    aboutAction->setToolTip(tr("Show information about PesoDigital"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for PesoDigital"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/PesoDigital"), tr("Show/Hide &PesoDigital"), this);
    toggleHideAction->setToolTip(tr("Show or hide the PesoDigital window"));
    ...
    editConfigAction->setToolTip(tr("Edit the PesoDigital.conf file in the default text editor"));
...
#ifndef Q_OS_MAC
            setWindowIcon(QIcon(":icons/PesoDigital_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/PesoDigital_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PesoDigital client"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide PesoDigital"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PesoDigital network", "", count));
}
