...
// for both PesoDigitald and PesoDigital(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of PesoDigital releases, the client name should be selected from
