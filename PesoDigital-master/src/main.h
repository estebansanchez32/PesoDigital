...
static const unsigned int POW_START_TIME = 1418403600; // Fre 12 Dec 2014 12:00:00 PM EST
...
public:
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // PesoDigital: get transaction coin age
...
public:
    ...
    // PesoDigital: block signature - signed by coin base txout[0]'s owner
    ...
    // PesoDigital: two types of block: proof-of-work or proof-of-stake
    ...
    // PesoDigital: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // PesoDigital: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // PesoDigital: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // PesoDigital: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // PesoDigital: block index flags
    enum
    {
